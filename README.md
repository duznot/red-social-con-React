# Rehaciendo mi red social con React
## Índice
...
código para reusarlo (lo cual es un gran valor per se), sino que adoptamos una
**arquitectura**, una serie de **principios de diseño**, un **paradigma**, unas
**abstracciones**, un **vocabulario**, una **comunidad**, ...

Como desarrollador Front-end, estos kits de desarrollo pueden resultarte
...
Este proyecto fue adaptado a partir del proyecto "Red Social" del bootcamp de Laboratoria. Más detalles [aquí](https://github.com/laboratoria-learning/project-prueba). Créditos al equipo de Laboratoria por el proyecto original.
